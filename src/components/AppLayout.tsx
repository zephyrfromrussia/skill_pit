...
export function AppLayout(props: { children: ReactNode }) {
  ...
  return (
    <div className="min-h-dvh bg-zinc-50 text-zinc-900 dark:bg-zinc-950 dark:text-zinc-50">
      <div className="mx-auto grid w-full max-w-6xl grid-cols-1 gap-0 px-4 py-6 md:grid-cols-[260px_1fr] md:gap-8">
        <aside className="md:sticky md:top-6 md:h-[calc(100dvh-48px)]">
