        ...
        <div className="rounded-2xl border border-zinc-200 bg-white p-5 dark:border-zinc-800 dark:bg-zinc-950">
          ...
          <div className="mt-6 rounded-2xl border border-zinc-200 bg-zinc-50 p-4 dark:border-zinc-800 dark:bg-zinc-900/40">
            ...
            <div className="mt-3 flex flex-wrap gap-3">
              <button
                type="button"
                onClick={() => inspectDemo('react-basics')}
                disabled={inspecting}
                className="inline-flex items-center rounded-xl border border-zinc-200 bg-white px-4 py-2 text-sm font-medium text-zinc-800 hover:bg-zinc-50 disabled:cursor-not-allowed disabled:opacity-50 dark:border-zinc-800 dark:bg-zinc-950 dark:text-zinc-100 dark:hover:bg-zinc-900"
              >
                {inspecting ? 'Проверяю…' : 'Проверить react-basics'}
              </button>
              <button
                type="button"
                onClick={() => installDemo('react-basics')}
                disabled={installing}
                className="inline-flex items-center rounded-xl bg-zinc-900 px-4 py-2 text-sm font-medium text-white hover:bg-zinc-800 disabled:cursor-not-allowed disabled:opacity-50 dark:bg-zinc-100 dark:text-zinc-900 dark:hover:bg-white"
              >
                {installing ? 'Устанавливаю…' : 'Установить react-basics'}
              </button>
            </div>
          </div>
